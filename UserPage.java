...
public class UserPage extends BaseTest 
{
	...
	@FindBy(xpath="//P[@class='date-txt'][text()='31 | Mar']")
...
//	public static WebElement read;
	...
	@FindBy(xpath="//BUTTON[@class='btn read-articles-btn'][text()='Read']")
	public static WebElement read;
	...
	@FindBy(xpath="//H6[@id='5c231e565baf780f39333ec6']")
	...
	{
		CommonMethods.wait(driver, arrowIcon);
		CommonMethods.click(arrowIcon);
		CommonMethods.wait(driver, userName);
	...
	{
		CommonMethods.wait(driver,drives);
		CommonMethods.click(drives);
		CommonMethods.wait(driver,march);
		CommonMethods.click(march);
//		CommonMethods.wait(driver,icon);
//		CommonMethods.click(icon);
//		CommonMethods.clickable(register);	
	...
	public void recommendingConnections(String search,String text) throws Exception
	{
		...
		CommonMethods.wait(driver,searchElement1);
		CommonMethods.click(searchElement1);
		CommonMethods.wait(driver,Recommend);
		CommonMethods.click(Recommend);
		CommonMethods.wait(driver,managingProfile);
		CommonMethods.click(managingProfile);
		CommonMethods.wait(driver,dropdown);
		CommonMethods.click(dropdown);
		CommonMethods.wait(driver,feedback);
...
//		CommonMethods.clickable(connect);
	...
	{
		CommonMethods.wait(driver,friends);
		CommonMethods.click(friends);
		CommonMethods.wait(driver,friendsRecommend);
		CommonMethods.click(friendsRecommend);
		CommonMethods.wait(driver,manageFriends);
		CommonMethods.click(manageFriends);
		CommonMethods.wait(driver,friendsDropdown);
	...
	{
		CommonMethods.wait(driver,messages);
		CommonMethods.click(messages);
		CommonMethods.wait(driver,messagesProfile);
		CommonMethods.click(messagesProfile);
		CommonMethods.wait(driver,chat);
	...
	{
		CommonMethods.wait(driver,logoutImage);
		CommonMethods.click(logoutImage);
		CommonMethods.wait(driver,signOut);
		CommonMethods.click(signOut);
		CommonMethods.wait(driver,logOut);
